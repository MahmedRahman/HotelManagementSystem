                    ...
                    child: Column(
                      children: [
                        ...
                        buildStatusFormField(
                          labelText: 'الحالة',
                          initialValue: optionEntity.state,
                          onChanged: (value) {
                            optionEntity.state = value;
                          },
                        ),
                        kSizedBoxSpaceH10(),
                        buildTextFormField(
                          ...
                          onChanged: (vlu) => optionEntity.order = int.tryParse(vlu.toString()),
                          onSaved: (value) {
                            optionEntity.order = int.tryParse(value.toString());
                          },
                        ),
                        kSizedBoxSpaceH10(),
                      ],
